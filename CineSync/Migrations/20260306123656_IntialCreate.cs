        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableMoviesCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_Platforms_PlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AvailableOnId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    PlatformId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableOnPlatforms", x => x.AvailableOnId);
                    table.ForeignKey(
                        name: "FK_AvailableOnPlatforms_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AvailableOnPlatforms_Platforms_PlatformId",
                        column: x => x.PlatformId,
                        principalTable: "Platforms",
                        principalColumn: "PlatformId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableOnPlatforms_MovieId",
                table: "AvailableOnPlatforms",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_AvailableOnPlatforms_PlatformId",
                table: "AvailableOnPlatforms",
                column: "PlatformId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_PlatformId",
                table: "Subscriptions",
                column: "PlatformId");
        }
